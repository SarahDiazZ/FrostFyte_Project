...
*/
//Version
#macro game_name						"Platform Fighter Engine: Core" //{string} The name of the game.
#macro version_string					"1.3.4" //{string} The current game version.
...
#macro touch_stick_type					TOUCH_STICK_TYPE.absolute //{int} The type of touch control stick to use, from the TOUCH_STICK_TYPE enum.
