...
function character_init2() {
	...
	if (_set_attacks)
		...
		my_attacks[$ "DashAtk"	] = dash_attack_mewtwo;
		my_attacks[$ "Ftilt"	] = ftilt_sheik;
		my_attacks[$ "Utilt"	] = utilt2;
		...
		my_attacks[$ "Fair"		] = fair_slash;
		my_attacks[$ "Bair"		] = bair_mario;
		my_attacks[$ "Uair"		] = uair_mario;
		my_attacks[$ "Dair"		] = dair_falco;
				 
		my_attacks[$ "Nspec"	] = nspec_homing_attack;
		...
		my_attacks[$ "Taunt"	] = taunt2;
		my_attacks[$ "Final"	] = final_smash2;
		}
	...
	if (_set_sprites)
		...
		my_sprites[$ "Entrance"	] = anim_define(spr_entrance2, anim_define_ext(spr_idle2, 0, 0.18));
		my_sprites[$ "Idle"		] = anim_define_ext(spr_idle2, 0, 0.18);
