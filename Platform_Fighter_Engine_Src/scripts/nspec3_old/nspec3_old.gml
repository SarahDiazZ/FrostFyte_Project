			...
			case 3:
				...
				if (attack_frame == 18)
					...
					if (stick_tilted(Lstick, DIR.up, 0))
						{
						var _hitbox = hitbox_create_targetbox(32, -8, 2, 2, 6, 11, 0.2, 7, 95, 1, SHAPE.square, 1, grabbed_id);
						_hitbox.custom_hitstun = 40;
						_hitbox.knockback_state = PLAYER_STATE.balloon;
						}
					else
						{
						var _hitbox = hitbox_create_targetbox(32, -8, 2, 2, 6, 8, 0.2, 7, 50, 1, SHAPE.square, 1, grabbed_id);
